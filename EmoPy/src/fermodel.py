...
class FERModel:
    ...
    **Example**::
    ...
    def _choose_model_from_target_emotions(self):
        ...
        model_file = 'conv_model_%s.hdf5' % model_suffix
        emotion_map_file = 'conv_emotion_map_%s.json' % model_suffix
        emotion_map = json.loads(open(resource_filename('models', emotion_map_file)).read())
        return load_model(resource_filename('models', model_file)), emotion_map
