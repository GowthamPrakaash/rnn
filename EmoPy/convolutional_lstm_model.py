...
print('Loading data...')
directory_path = "dataset/image_data/sample_image_series_directory"
...
model.export_model('output/conv_lstm_model.json','output/conv_lstm_weights.h5',"output/conv_lstm_emotion_map.json", dataset.get_emotion_index_map())
